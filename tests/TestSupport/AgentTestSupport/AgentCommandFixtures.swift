...
public enum AgentCommandFixtures {
    ...
    public static func dispatchParitySamples() -> [AgentCommand] {
        [
            ...
            .revertFile(file: ChangedFile(relativePath: "Sources/App.swift")),
            .revertHunk(file: ChangedFile(relativePath: "Sources/App.swift"), hunkID: IDs.hunk),
    ...
    public static func wireRoundTripExtras(bubbleID: UUID, permissionID: UUID) -> [AgentCommand] {
        [
            ...
            .revertFile(file: ChangedFile(relativePath: "src/foo.swift")),
            .revertHunk(file: ChangedFile(relativePath: "src/foo.swift"), hunkID: bubbleID),
